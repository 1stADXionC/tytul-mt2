...
#ifdef ENABLE_MEMLEKET_SYSTEM
		static void RegisterMemleketName(BYTE iIndex, const char* c_szTitleName);
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
		void					SetMemleket(const BYTE val) { m_bMemleket = val; RefreshTextTailTitle(); }
		BYTE					GetMemleket() const { return m_bMemleket;}
#endif

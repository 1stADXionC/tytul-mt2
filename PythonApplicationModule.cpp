...
void initapp()
{
	...
	PyModule_AddIntConstant (poModule, "ENABLE_MEMLEKET_SYSTEM", 1);
#else
	PyModule_AddIntConstant (poModule, "ENABLE_MEMLEKET_SYSTEM", 0);
#endif
...
#if defined(FOG_FIX)
	PyModule_AddIntConstant (poModule, "FOG_FIX", true);
#else
	PyModule_AddIntConstant (poModule, "FOG_FIX", false);
#endif

#if defined(SAVE_CAMERA_MODE)
	PyModule_AddIntConstant (poModule, "SAVE_CAMERA_MODE", true);
#else
	PyModule_AddIntConstant (poModule, "SAVE_CAMERA_MODE", false);
#endif
}

...
#ifdef ENABLE_MEMLEKET_SYSTEM
		kNetActorData.m_bMemleket = chrInfoPacket.bMemleket;
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
	kNetActorData.m_bMemleket = chrAddPacket.bMemleket;
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
	kNetUpdateActorData.m_bMemleket = chrUpdatePacket.bMemleket;
#endif

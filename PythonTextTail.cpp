...
const float c_TextTail_Name_Position_Default = 15.0f;
const float c_fyGuildNamePosition_Default = -10.0f;

#ifdef ENABLE_MEMLEKET_SYSTEM
const float c_TextTail_Name_Position_WithMemleket = 25.0f;
const float c_fyGuildNamePosition_WithMemleket = 15.0f;
const float c_fMemleketPosition = -10.0f;
#endif
...
void CPythonTextTail::ArrangeTextTail()
{
	...
	for (itor = m_CharacterTextTailList.begin(); itor != m_CharacterTextTailList.end(); ++itor)
	{
		...
		float fNameY = pTextTail->y;
		float fGuildY = pTextTail->y - c_fyGuildNamePosition_Default;
#ifdef ENABLE_MEMLEKET_SYSTEM
		float fMemleketY = pTextTail->y;
		if (pTextTail->psMemleketNameTextInstance)
		{
			fNameY = pTextTail->y - (c_TextTail_Name_Position_WithMemleket - c_TextTail_Name_Position_Default);
			fGuildY = pTextTail->y;
			fMemleketY = pTextTail->y - c_fMemleketPosition;
		}
#endif
		...
		if (pMarkInstance && pGuildNameInstance)
		{
			...
			pGuildNameInstance->SetPosition (pTextTail->x + iImageHalfSize, fGuildY, pTextTail->z);
...
#ifdef ENABLE_MEMLEKET_SYSTEM
		CGraphicTextInstance* psMemleketNameInstance = pTextTail->psMemleketNameTextInstance;
		if (psMemleketNameInstance)
		{
			psMemleketNameInstance->SetPosition(pTextTail->x, fMemleketY, pTextTail->z);
			psMemleketNameInstance->Update();
		}
#endif

		pTextTail->pTextInstance->SetColor (pTextTail->Color.r, pTextTail->Color.g, pTextTail->Color.b);
		pTextTail->pTextInstance->SetPosition (pTextTail->x + fxAdd, fNameY, pTextTail->z);
...
void CPythonTextTail::Render()
{
	...
	for (itor = m_CharacterTextTailList.begin(); itor != m_CharacterTextTailList.end(); ++itor)
	{
		...
		if (pTextTail->psMemleketNameTextInstance)
		{
			pTextTail->psMemleketNameTextInstance->Render();
		}
#endif
	}
...
void CPythonTextTail::ShowCharacterTextTail (DWORD VirtualID)
{
	...
	// NOTE : ShowAll ÿ  Instance  Pointer  ãƼ üũϹǷ ϰ ɸ ɼ ִ.
...
#endif
{
...
#ifdef ENABLE_MEMLEKET_SYSTEM
	pTextTail->psMemleketNameTextInstance = NULL;
#endif
	...
	if (0 != dwGuildID)
	{
		...
		if (dwNewIsGuildName == 3)
			strGuildName += ENABLE_SHOW_LIDER_AND_GENERAL_GUILD_VALUE1;
		else if (dwNewIsGuildName == 2)
			strGuildName += ENABLE_SHOW_LIDER_AND_GENERAL_GUILD_VALUE2;
#endif

		int iGuildLevel = 0;
		CPythonGuild::Instance().GetGuildLevel(dwGuildID, &iGuildLevel);

		float gr = c_TextTail_Guild_Name_Color.r;
		float gg = c_TextTail_Guild_Name_Color.g;
		float gb = c_TextTail_Guild_Name_Color.b;

		switch (iGuildLevel)
		{
			case 1:  gr = 1.000f; gg = 1.000f; gb = 1.000f; break; // #FFFFFF
			case 2:  gr = 1.000f; gg = 1.000f; gb = 0.498f; break; // #FFFF7F
			case 3:  gr = 0.882f; gg = 0.882f; gb = 0.000f; break; // #E1E100
			case 4:  gr = 0.800f; gg = 1.000f; gb = 0.000f; break; // #CCFF00
			case 5:  gr = 0.600f; gg = 1.000f; gb = 0.000f; break; // #99FF00
			case 6:  gr = 0.400f; gg = 1.000f; gb = 0.000f; break; // #66FF00
			case 7:  gr = 0.000f; gg = 1.000f; gb = 0.000f; break; // #00FF00
			case 8:  gr = 0.000f; gg = 0.914f; gb = 0.251f; break; // #00E940
			case 9:  gr = 0.000f; gg = 0.824f; gb = 0.000f; break; // #00D200
			case 10: gr = 0.000f; gg = 0.773f; gb = 0.478f; break; // #00C57A
			case 11: gr = 0.000f; gg = 0.725f; gb = 0.600f; break; // #00B999
			case 12: gr = 0.000f; gg = 0.659f; gb = 0.714f; break; // #00A8B6
			case 13: gr = 0.000f; gg = 0.600f; gb = 0.816f; break; // #0099D0
			case 14: gr = 0.157f; gg = 0.592f; gb = 0.945f; break; // #2897F1
			case 15: gr = 0.196f; gg = 0.616f; gb = 1.000f; break; // #329DFF
			case 16: gr = 0.408f; gg = 0.604f; gb = 1.000f; break; // #689AFF
			case 17: gr = 0.506f; gg = 0.620f; gb = 1.000f; break; // #819EFF
			case 18: gr = 0.592f; gg = 0.533f; gb = 1.000f; break; // #9788FF
			case 19: gr = 0.690f; gg = 0.494f; gb = 1.000f; break; // #B07EFF
			case 20: gr = 0.784f; gg = 0.455f; gb = 1.000f; break; // #C874FF
			case 21: gr = 0.851f; gg = 0.471f; gb = 1.000f; break; // #D978FF
			case 22: gr = 0.847f; gg = 0.651f; gb = 0.969f; break; // #D8A6F7
			case 23: gr = 0.914f; gg = 0.788f; gb = 1.000f; break; // #E9C9FF
			case 24: gr = 1.000f; gg = 0.741f; gb = 0.941f; break; // #FFBDF0
			case 25: gr = 1.000f; gg = 0.569f; gb = 0.792f; break; // #FF91CA
			case 26: gr = 1.000f; gg = 0.420f; gb = 0.580f; break; // #FF6B94
			case 27: gr = 1.000f; gg = 0.361f; gb = 0.541f; break; // #FF5C8A
			case 28: gr = 1.000f; gg = 0.271f; gb = 0.427f; break; // #FF456D
			case 29: gr = 1.000f; gg = 0.271f; gb = 0.271f; break; // #FF4545
			case 30: gr = 1.000f; gg = 0.129f; gb = 0.129f; break; // #FF2121
		}
		...
		prGuildNameInstance->SetColor(gr, gg, gb);
...
void CPythonTextTail::RegisterItemTextTail (DWORD VirtualID, const char* c_szText, CGraphicObjectInstance* pOwner)
{
	...
	TTextTail* pTextTail = RegisterTextTail (VirtualID, c_szText, pOwner, c_TextTail_Name_Position_Default, c_TextTail_Item_Color);
...
void CPythonTextTail::DeleteTextTail (TTextTail* pTextTail)
{
	...
	if (pTextTail->psMemleketNameTextInstance)
	{
		CGraphicTextInstance::Delete(pTextTail->psMemleketNameTextInstance);
		pTextTail->psMemleketNameTextInstance = NULL;
	}
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
void CPythonTextTail::AttachMemleket(DWORD dwVID, const char* c_szName, const D3DXCOLOR& c_rColor)
{
	if (!bPKTitleEnable)
		return;
	...
	TTextTail* pTextTail = itor->second;
	CGraphicTextInstance*& prTitleNameInstance = pTextTail->psMemleketNameTextInstance;
...
void CPythonTextTail::DetachMemleket(DWORD dwVID)
{
	if (!bPKTitleEnable)
		return;

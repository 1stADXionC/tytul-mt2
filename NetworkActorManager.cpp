...
#ifdef ENABLE_MEMLEKET_SYSTEM
	kCreateData.m_bMemleket=rkNetActorData.m_bMemleket;
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
		pkInstFind->SetMemleket (c_rkNetUpdateActorData.m_bMemleket);
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
	rkNetActorData.m_bMemleket=c_rkNetUpdateActorData.m_bMemleket;
#endif

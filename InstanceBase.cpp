...
bool CInstanceBase::Create (const SCreateData& c_rkCreateData)
{
	...
	m_bMemleket = c_rkCreateData.m_bMemleket;
#endif
...
void CInstanceBase::StateProcess()
{
	while (1)
	{
		...
		*/
		...
		{
			Lognf (0, "vid=%d is skipped because you can't move. IsDead=%d, IsKnockDown=%d", uVID, m_GraphicThingInstance.IsDead(), m_GraphicThingInstance.IsKnockDown());
			return;
		}

...
class CPythonTextTail : public CSingleton<CPythonTextTail>
{
	public:
		typedef struct STextTail
		{
			...
			CGraphicTextInstance*			psMemleketNameTextInstance;
#endif
...
#ifdef ENABLE_MEMLEKET_SYSTEM
		void AttachMemleket (DWORD dwVID, const char* c_szName, const D3DXCOLOR& c_rColor);
		void DetachMemleket (DWORD dwVID);
#endif

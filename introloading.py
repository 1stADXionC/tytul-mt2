...
class LoadingWindow(ui.ScriptWindow):
	...
	def Open(self):
		...
		imgFileNameDict = {
			0 : "d:/ymir work/uiloading/loading0.sub",
			1 : "d:/ymir work/uiloading/loading1.sub",
			2 : "d:/ymir work/uiloading/loading2.sub",
			3 : "d:/ymir work/uiloading/loading3.sub",
		}
	...
	if app.ENABLE_MEMLEKET_SYSTEM:
		for i in xrange(len(localeInfo.MEMLEKET_LIST)):
			chrmgr.RegisterMemleketName(i, localeInfo.MEMLEKET_LIST[i])
